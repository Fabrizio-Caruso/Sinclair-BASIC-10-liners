...
3 print at 0,1;"$: ";9-f;"  score: ";j;"  hiscore: ";r:if screen$(py,px)=w then j=j+4:if f>0 then f=f-1
...
7 let g=0:IF y=1 THEN IF l=3 THEN let gx=int(rnd*32): let gy=int(rnd*18): print at gy,gx;"o"
