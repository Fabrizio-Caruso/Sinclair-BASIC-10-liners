0 let j = 0: let r = 0: let t = 250: let q = 0.9: border 5 : paper 0 : ink 7 : let m=87: let a$="": let k = 1: let e = 0: let s = 0: let e = 0: let l = 0
1 let f = 0: let px=16: let py=12: let k=1: cls: if j>r then let r=j:print at 0,0;"record!":for i=1 to t:next i:cls
2 let j= 0: let w=36:let h=81:print at 0,0;"use ijkl space":for i=1 to t:next i:cls:ink 2: print at 1,8;"ooo  mines ooo"
3 ink 5: print at 0,1;": ";9-f;"   score: ";j;"  high score: ";r:if screen$(py,px)="$" then let j=j+4:if f>0 then let f=f-1
